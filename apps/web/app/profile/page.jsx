  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Main Profile Card */}
        <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-purple-900/40 via-slate-900 to-blue-900/30 p-6 flex flex-col md:flex-row md:items-center gap-6">
          {/* ✅ Avatar: use profile picture if available, otherwise initial */}
          <div className="h-20 w-20 rounded-full overflow-hidden bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-3xl font-bold">
            {avatarUrl ? (
              <img
                src={avatarUrl}
                alt={displayName}
        ...
        {/* keep your Song of the Day section below if you have it */}
      </div>
    </div>
  );
}
