...
test.describe('Sign-Out Button E2E Tests', () => {
  test.beforeEach(async ({ page }) => {
    ...
    // Mock the user being logged in by intercepting the auth check
  ...
  test('sign-out button is responsive on mobile', async ({ page }) => {
    // Set mobile viewport
    ...
    // On mobile, text should be hidden but icon should be visible
